...
**
** Created: Mon Mar 21 15:06:42 2016
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        accept->setGeometry(QRect(30, 250, 98, 27));
        add = new QPushButton(centralWidget);
        add->setObjectName(QString::fromUtf8("add"));
        add->setGeometry(QRect(30, 290, 98, 27));
        mul = new QPushButton(centralWidget);
        mul->setObjectName(QString::fromUtf8("mul"));
        mul->setGeometry(QRect(30, 330, 98, 27));
        sub = new QPushButton(centralWidget);
        sub->setObjectName(QString::fromUtf8("sub"));
        sub->setGeometry(QRect(160, 290, 98, 27));
        disp = new QPushButton(centralWidget);
        disp->setObjectName(QString::fromUtf8("disp"));
        disp->setGeometry(QRect(160, 250, 98, 27));
        exit = new QPushButton(centralWidget);
        exit->setObjectName(QString::fromUtf8("exit"));
        exit->setGeometry(QRect(160, 380, 98, 27));
        transa = new QPushButton(centralWidget);
        transa->setObjectName(QString::fromUtf8("transa"));
        transa->setGeometry(QRect(160, 330, 98, 27));
        transb = new QPushButton(centralWidget);
        transb->setObjectName(QString::fromUtf8("transb"));
        transb->setGeometry(QRect(30, 370, 98, 27));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        transa->setText(QApplication::translate("MainWindow", "Transpose A", 0, QApplication::UnicodeUTF8));
        transb->setText(QApplication::translate("MainWindow", "Transpose B", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
